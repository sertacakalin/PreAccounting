...
export const categoryService = {
  // Income categories
  getAllIncome: () => api.get('/api/categories/income'),
  getIncomeById: (id) => api.get(`/api/categories/income/${id}`),
  createIncome: (data) => api.post('/api/categories/income', data),
  updateIncome: (id, data) => api.put(`/api/categories/income/${id}`, data),
  deleteIncome: (id) => api.delete(`/api/categories/income/${id}`),

  // Expense categories
  getAllExpense: () => api.get('/api/categories/expense'),
  getExpenseById: (id) => api.get(`/api/categories/expense/${id}`),
  createExpense: (data) => api.post('/api/categories/expense', data),
  updateExpense: (id, data) => api.put(`/api/categories/expense/${id}`, data),
  deleteExpense: (id) => api.delete(`/api/categories/expense/${id}`),
}
